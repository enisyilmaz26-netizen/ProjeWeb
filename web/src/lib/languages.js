export const translations = {
  ...
  studios_not_found: { TR: 'Bu il için stüdyo bulunamadı.', EN: 'No studios found for this province.' },
  ...
  back_to_studio: { TR: 'Stüdyo Seçimine Dön', EN: 'Back to Studio Selection' },
  ...
  studio_label: { TR: 'Stüdyo', EN: 'Studio' },
  date_label: { TR: 'Tarih', EN: 'Date' },
  time_label: { TR: 'Saat', EN: 'Time' },
  capacity_label: { TR: 'Kapasite', EN: 'Capacity' },
  delete_lab_confirm: { TR: 'Bu stüdyoyu silmek istediğinizden emin misiniz?', EN: 'Are you sure you want to delete this studio?' },
  ...
  tab_studios_label: { TR: 'Stüdyolar', EN: 'Studios' },
  ...
  search_placeholder: { TR: 'Ad, e-posta, stüdyo ara...', EN: 'Search name, email, studio...' },
  ...
  lbl_studio: { TR: 'Stüdyo', EN: 'Studio' },
  ...
  studio_add: { TR: '+ Stüdyo Ekle', EN: '+ Add Studio' },
  studio_new: { TR: 'Yeni Stüdyo', EN: 'New Studio' },
  studio_edit: { TR: 'Stüdyoyu Düzenle', EN: 'Edit Studio' },
  studio_city_required: { TR: 'İl ve stüdyo adı zorunludur.', EN: 'Province and studio name are required.' },
  studio_name_required: { TR: 'Stüdyo adı zorunludur.', EN: 'Studio name is required.' },
  ...
  confirm_revoke_user: { TR: "Bu üyenin erişimini kaldırmak istediğinizden emin misiniz?", EN: "Are you sure you want to revoke this member's access?" },

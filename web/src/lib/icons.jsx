import { Mic, Camera, Monitor, Pencil } from 'lucide-react'
...
export function getLabIcon(name = '', size = 'md') {
  ...
  if (n.includes('video') || n.includes('yeşil ekran') || n.includes('green') || n.includes('kamera')) return <Camera className={cls} />

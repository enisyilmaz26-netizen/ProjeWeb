      ...
      <div ref={trapRef} role="dialog" aria-modal="true" aria-labelledby="idle-warning-title" className="bg-white dark:bg-[#0D1E3D] rounded-2xl shadow-2xl p-6 max-w-sm w-full">
        ...
        <div className="flex gap-3">
          <button
            autoFocus
            onClick={onContinue}
            className="flex-1 py-2.5 bg-[#1565C0] dark:bg-[#7DD4FC] text-white dark:text-[#060E26] text-sm font-semibold rounded-xl hover:opacity-90 active:scale-[0.98] transition"
          >

...
export default function AppointmentsTab({ language, isGlobal, adminCityId, onRequestConfirm }) {
  ...
  const handleMarkCompleted = (id) => onRequestConfirm(t('confirm_complete_appt', language), async () => { setProcessingId(id); await markAppointmentCompleted(id); setProcessingId(null) })
